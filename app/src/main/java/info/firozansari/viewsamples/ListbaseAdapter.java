...
public class ListbaseAdapter extends BaseAdapter {
    ...
    Context context;
    ArrayList<Dashboardmodel> bean;


    public ListbaseAdapter(Context context, ArrayList<Dashboardmodel> bean) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.dashboard_list, null);
        ...
        Dashboardmodel bean = (Dashboardmodel)getItem(position);
